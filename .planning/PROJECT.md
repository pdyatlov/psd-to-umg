...
**v1.0.1 shipped 2026-04-17. Phase 22 (stroke rendering) complete 2026-04-29. Phase 23 (pattern fill layers) complete 2026-05-04 — PTFL-01 (EPsdLayerType::PatternFill + adjPattern/PtFl detection + ExtractImagePixels Adj-cast path in parser), PTFL-02 (FPatternFillLayerMapper at priority 101 + registration + CanMap matrix spec + D-04 nullptr fallback). Pattern fill layers now produce UImage backed by composited RGBAPixels instead of silently falling through to Unknown. Positive PatternFill.psd fixture deferred to D-05 user-supplied.**

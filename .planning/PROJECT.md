...
**v1.0.1 shipped 2026-04-17. Phase 22 (stroke rendering) complete 2026-04-29 — STROKE-01 (lfx2 stroke sibling for Image/Shape), STROKE-02 (vstk parser + ScanVstkStroke), STROKE-03 (vstk stroke sibling for Shape) all done. Positive vstk fixture (Stroke.psd) and visual UAT deferred to pre-v1.3 session per D-04.**

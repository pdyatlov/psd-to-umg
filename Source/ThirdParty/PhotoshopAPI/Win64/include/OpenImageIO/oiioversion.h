...
namespace OpenImageIO_v3_0 { }
namespace OIIO = OpenImageIO_v3_0;

// Macros to use in each file to enter and exit the right name spaces.
#define OIIO_NAMESPACE OpenImageIO_v3_0
#define OIIO_NAMESPACE_STRING "OpenImageIO_v3_0"
#define OIIO_NAMESPACE_BEGIN namespace OpenImageIO_v3_0 {
